...
class ExpandNet(nn.Module):
    def __init__(self):
        ...
        self.mid_net = nn.Sequential(
            layer(3, 64, 3, 1, 2, 2), layer(64, 64, 3, 1, 2, 2),
            layer(64, 64, 3, 1, 2, 2), nn.Conv2d(64, 64, 3, 1, 2, 2))
        ...
        with torch.no_grad():
            ...
            for h_index in range(num_h):
                for w_index in range(num_w):
                    ...
                    exp_glob = glob.expand(1, 64, h_end - h_start,
                                           w_end - w_start)
                    ...
                    result[:, :, h_start_stitch:h_end_stitch, w_start_stitch:
                           w_end_stitch].copy_(res_slice)
